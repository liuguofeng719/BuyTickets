...
/**
 * Created by liuguofeng719 on 2016/9/9.
 */
public class TravelVehicleOrdersDetailsVoResp extends BaseInfoVo {

    @SerializedName("VehicleOrdersDetails")
    public VehicleOrdersDetails vehicleOrdersDetails;
    @SerializedName("AssignedCarDetail")
    public AssignedCarDetail assignedCarDetail;
